...
最新可交付文件为 `E2AG-paper-anonymous-v1.1.23-20260817.pdf`。v1.1.23 在保留图1三个等宽平面和独立边界标注区的基础上，重新分配四列节点位置并把平面宽度调整为150mm，使执行平面的三段框间净距约为3mm--4mm；第三、第四节点之间具有完整可辨的箭身和箭头。该版保持16页，LaTeX 日志无未解析引用或 Overfull 警告，SHA-256 为 `60F38ED39E4A08516A092AE18814A451D0C3702E972AE0217B7A17E50A4D57B2`。
