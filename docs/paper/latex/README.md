...
最新可交付文件为 `E2AG-paper-anonymous-v1.1.4-20260815.pdf`。v1.1.4 是不改变正文和实验数字的配图修订版：图 2 采用与图 1 相同的 154 mm 外框、标题偏移、平面间 6.5 mm 路由通道和证据区内边距，并将五个主路径节点调整为对称等距列；图 1 与图 2 统一使用点线空心燕尾箭头表示证据写入。
