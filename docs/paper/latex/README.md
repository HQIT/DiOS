...
非匿名作者信息稿为 `e2ag-paper-v1.1-authors.tex`，对应预览文件为 `E2AG-paper-authors-v1.1.31-20260817.pdf`，SHA-256 为 `B5690ACDCD10FD26CB77F83D23B6534D00D6C9BC799C6411EC88FBB68BDBA7A9`。最终作者顺序为徐刚、冯骐、姚俊杰、肖宇、陈铭松、王江涛、杨世光、饶振宇、王语欣；徐刚和王江涛同时标注国家可信嵌入式软件工程技术研究中心与华东师范大学软件工程学院。投稿声明使用作者自有模板，保密审查单已由作者准备，全体手写签名与最终上传均由作者处理。
