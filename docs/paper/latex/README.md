...
最新可交付文件为 `E2AG-paper-anonymous-v1.1.5-20260815.pdf`。v1.1.5 是不改变正文和实验数字的配图修订版：图 2 的治理分支改用完整轮廓的空心三角箭头，并从状态胶囊侧面水平进入，使拒绝、等待审批和调用拒绝的方向在缩印时仍可直接辨认；其余版式沿用 v1.1.4 的统一网格。
