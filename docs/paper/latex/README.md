...
最新可交付文件为 `E2AG-paper-anonymous-v1.1.3-20260815.pdf`。v1.1.3 是不改变正文和实验数字的配图修订版：图 2 改为边界内的五列主路径、独立治理分支行和独立证据平面，消除节点越界、标签重叠和拥挤回路；图 1 与图 2 统一使用点线空心燕尾箭头表示证据写入。
