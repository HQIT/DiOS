...
最新可交付文件为 `E2AG-paper-anonymous-v1.1.22-20260817.pdf`。v1.1.22 调整图1执行平面的标题留白与左右边界通道：三个平面收敛为统一宽度，执行平面增高，节点按新列网格对齐；“事件域/TB1”和“工具域/TB2”移至外框之外的独立标注区，文字、箭头和外框不再相交。该版保持16页，LaTeX 日志无未解析引用或 Overfull 警告，SHA-256 为 `FD52DB95B09C33CC4102E97382DC6077BE85C241B148968CFF018DF86F28CA1E`。
