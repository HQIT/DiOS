...
\end{tikzpicture}
\caption{事件到智能体治理（Event-to-Agent Governance，E2AG）跨层授权执行流程。两个等宽平面共享左右边界；实心箭头表示主执行路径，空心三角箭头表示治理分支，点线空心燕尾箭头表示证据写入，圆角胶囊表示暂停或终止状态。PEP、A2A 和 MCP 分别表示 policy enforcement point、Agent2Agent 和 Model Context Protocol。}
