...
\begin{tikzpicture}[
  font=\footnotesize,
  component/.style={draw=black!55,rounded corners=1.5pt,align=center,
    minimum width=30mm,minimum height=9mm,inner xsep=3pt,fill=black!2},
  e2ag/.style={component,draw=blue!65!black,fill=blue!7,line width=.8pt},
  future/.style={component,dashed,draw=black!55,fill=white},
  domainbox/.style={draw=black!22,rounded corners=3pt,fill=black!0,
    inner xsep=3mm,inner ysep=5mm},
  audit/.style={draw=purple!60!black,rounded corners=2pt,fill=purple!5,
    align=center,minimum height=8mm},
  flow/.style={-{Latex[length=1.8mm]},line width=.7pt},
  evidence/.style={-{Latex[length=1.5mm]},draw=purple!60!black,dashed,line width=.55pt},
  boundary/.style={draw=red!55!black,dashed,line width=.55pt}
]
...
\node[below=2mm of auditlog,font=\scriptsize,align=center] (legend)
  {灰色：当前 DiOS/DiAgent 基线\quad
   \textcolor{blue!65!black}{蓝色：E2AG 治理机制}\quad
   虚线框：Roadmap 或本文未统一中介的路径\quad
   \textcolor{red!55!black}{红色虚线：信任边界}};
\end{tikzpicture}
}
...
图中灰色节点是当前 DiOS/DiAgent 基线，蓝色节点是 E2AG 新增或强化的治理机制，虚线节点表示 Roadmap 或本文尚未统一中介的路径。跨域箭头对应外部输入、控制面到运行时、运行时到工具三类信任边界。该图只说明论文相关的系统上下文，不把 DiOS 管理界面、模型服务和全部应用层能力列为本文贡献。
