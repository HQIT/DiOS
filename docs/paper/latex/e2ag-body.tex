...
\draw[evidence] (domain2.south)--(auditlog.north west);
\draw[evidence] (domain3.south)--(auditlog.north);
\draw[evidence] (domain4.south)--(auditlog.north east);
...
\bibitem{dios} HQIT. DiOS: DiFlow Intelligent Operation System. \url{https://github.com/HQIT/DiOS}. [2026-08-14]
