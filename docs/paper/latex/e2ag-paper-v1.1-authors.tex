...
\title{\bfseries\zihao{-2} 事件驱动智能体操作系统跨层能力治理方法\\[0.25em]
{\zihao{-3}（人工智能操作系统及其安全专刊）}}
\author{徐刚$^{1,3}$，冯骐$^{2}$，姚俊杰$^{3}$，肖宇$^{3}$，陈铭松$^{3}$，\\
王江涛$^{1,3,*}$，杨世光$^{3}$，饶振宇$^{3}$，王语欣$^{3}$\\[0.45em]
...
\texttt{yxiao@sei.ecnu.edu.cn；mschen@sei.ecnu.edu.cn；jtwang@sei.ecnu.edu.cn；}\\[-0.1em]
\texttt{71265902107@stu.ecnu.edu.cn；51285902217@stu.ecnu.edu.cn；51285902161@stu.ecnu.edu.cn}
\end{center}
